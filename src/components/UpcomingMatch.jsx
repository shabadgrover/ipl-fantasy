    ...
    <div className="max-w-6xl mx-auto px-4 pb-20">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
          <div>
            ...
            <h2 className="text-3xl md:text-5xl font-black text-slate-900 dark:text-white tracking-tighter mb-2 italic text-shiny flex items-center gap-4">
              <img src={`/Logos/dark/${matchInfo.abbrs[0].toLowerCase()}.png`} alt={matchInfo.abbrs[0]} className="w-10 h-10 md:w-16 md:h-16 object-contain dark:hidden" />
              ...
              <img src={`/Logos/dark/${matchInfo.abbrs[1].toLowerCase()}.png`} alt={matchInfo.abbrs[1]} className="w-10 h-10 md:w-16 md:h-16 object-contain dark:hidden" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="glass-card rounded-[2.5rem] p-8 border border-black/5 dark:border-white/5 transition-colors duration-300">
          <div className="flex items-center gap-3 mb-8">
            <div className="w-12 h-12 rounded-xl bg-white/10 border border-black/10 dark:bg-white/10 dark:border-white/20 shadow-sm flex items-center justify-center p-1.5 overflow-hidden">
              <img src={`/Logos/dark/${matchInfo.abbrs[0].toLowerCase()}.png`} alt={matchInfo.abbrs[0]} className="w-full h-full object-contain dark:hidden" />
        ...
        <div className="glass-card rounded-[2.5rem] p-8 border border-black/5 dark:border-white/5 transition-colors duration-300">
          <div className="flex items-center gap-3 mb-8">
            <div className="w-12 h-12 rounded-xl bg-white/10 border border-black/10 dark:bg-white/10 dark:border-white/20 shadow-sm flex items-center justify-center p-1.5 overflow-hidden">
              <img src={`/Logos/dark/${matchInfo.abbrs[1].toLowerCase()}.png`} alt={matchInfo.abbrs[1]} className="w-full h-full object-contain dark:hidden" />
