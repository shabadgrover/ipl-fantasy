              ...
              {upcomingMatch && (
                <div className="flex items-center gap-3 bg-white/5 px-3 py-1.5 rounded-xl border border-white/10">
                  ...
                  <div className="flex items-center gap-2">
                    <img src={`/Logos/dark/${upcomingMatch.abbrs[0].toLowerCase()}.png`} alt={upcomingMatch.abbrs[0]} className="w-4 h-4 object-contain dark:hidden" />
                    ...
                    <img src={`/Logos/dark/${upcomingMatch.abbrs[1].toLowerCase()}.png`} alt={upcomingMatch.abbrs[1]} className="w-4 h-4 object-contain dark:hidden" />
