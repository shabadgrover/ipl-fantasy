...
const MobileNav = ({ activeTab, onNavigate }) => {
  ...
  return (
    ...
    >
      <div className="bg-black/40 backdrop-blur-2xl border border-white/10 rounded-3xl h-16 flex items-center justify-around shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
        {navItems.map((item) => (
          <button
            key={item.id}
