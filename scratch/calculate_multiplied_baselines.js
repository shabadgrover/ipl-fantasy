...
discoveredTeams.forEach(team => {
  ...
  for (let i = 2; i < rows.length; i++) {
    ...
    calculatedTotal += pointsP1 + pointsP2;
  }
  
  multipliedStandings[team.name] = calculatedTotal;
});

console.log("Match 52 Multiplied Standings:");
console.log(JSON.stringify(multipliedStandings, null, 2));
