...
const match60Points = {
  // KKR
  "Finn Allen": 193,
  "Angkrish Raghuvanshi": 170,
  "Cameron Green": 150,
  "Sunil Narine": 88,
  "Ajinkya Rahane": 28,
  "Matheesha Pathirana": 12,
  "Kartik Tyagi": 10,
...
discoveredTeams.forEach(team => {
    ...
    for (let r = 2; r < rows.length; r++) {
        ...
        for (const [key, val] of Object.entries(match60Points)) {
