...
const match65 = matches.find(m => m.id === 65);
if (match65 && match65.isCompleted) {
  console.log("⚠️ Match 65 is already marked as completed in matches.js. Exiting to prevent duplicate updates.");
  process.exit(0);
}
...
discoveredTeams.forEach(team => {
    ...
    for (let r = 2; r < rows.length; r++) {
        ...
        for (const [key, val] of Object.entries(match65Points)) {
