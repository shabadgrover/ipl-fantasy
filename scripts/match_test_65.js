...
const screenshotPlayers = [
  // KKR
  "Saurabh Dubey", "Cameron Green", "Manish Pandey", "Kartik Tyagi",
  "Sunil Narine", "Rovman Powell", "Ajinkya Rahane", "Anukul Roy",
  "Varun Chakravarthy", "Rinku Singh", "Tejasvi Dahiya", "Finn Allen",
  "Angkrish Raghuvanshi",
  // MI
  "Corbin Bosch", "Deepak Chahar", "Jasprit Bumrah", "Hardik Pandya",
  "AM Ghazanfar", "Will Jacks", "Suryakumar Yadav", "Rohit Sharma",
  "Ryan Rickelton", "Tilak Varma", "Raghu Sharma", "Naman Dhir"
];
...
console.log("MATCHING RESULTS FOR MATCH 65:");
