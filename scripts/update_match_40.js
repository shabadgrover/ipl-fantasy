...
discoveredTeams.forEach(team => {
  ...
  for (let r = 2; r < rows.length; r++) {
    ...
    if (matchPoints !== 0) {
      ...
      console.log(`[${team.name}] Added ${matchPoints} raw points to ${cleanName} (Multiplied: ${matchPoints * multiplier})`);
    }
  }
