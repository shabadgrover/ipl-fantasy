...
const match67 = matches.find(m => m.id === 67);
if (match67 && match67.isCompleted) {
  console.log("⚠️ Match 67 is already marked as completed in matches.js. Exiting to prevent duplicate updates.");
  process.exit(0);
}
...
discoveredTeams.forEach(team => {
    ...
    for (let r = 2; r < rows.length; r++) {
        ...
        for (const [key, val] of Object.entries(match67Points)) {
