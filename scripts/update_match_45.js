...
const match45Points = {
  ...
  "Heinrich Klaasen": 33,
  "Eshan Malinga": 24,
  "Ravichandran Smaran": 20,
  "Harshal Patel": 18,
  "Aniket Verma": 14,
  "Salil Arora": 6,
  // KKR
  "Varun Chakravarthy": 124,
  "Angkrish Raghuvanshi": 111,
  "Sunil Narine": 98,
  "Ajinkya Rahane": 89,
  "Kartik Tyagi": 84,
  "Finn Allen": 69,
...
discoveredTeams.forEach(team => {
  ...
  for (let r = 2; r < rows.length; r++) {
    ...
    const matchPoints = match45Points[cleanName] || 0;
