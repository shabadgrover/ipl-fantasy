...
mapping.forEach(base => {
    ...
    results.push({
        id: base.name,
        totalPoints: total,
        previousPoints: match20[base.name],
        diff: total - match20[base.name]
    });
});

results.sort((a,b) => b.totalPoints - a.totalPoints);

const prevRanks = Object.keys(match20).sort((a,b) => match20[b] - match20[a]);
...
console.log(JSON.stringify({ results, teamPlayerPoints }, null, 2));
