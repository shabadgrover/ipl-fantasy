...
const match70 = matches.find(m => m.id === 70);
if (match70 && match70.isCompleted) {
  console.log("⚠️ Match 70 is already marked as completed in matches.js. Exiting to prevent duplicate updates.");
  process.exit(0);
}
...
discoveredTeams.forEach(team => {
    ...
    for (let r = 2; r < rows.length; r++) {
        ...
        for (const [key, val] of Object.entries(match70Points)) {
