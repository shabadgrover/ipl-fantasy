...
const match51Points = {
  ...
  "Vaibhav Arora": 44,
  "Ajinkya Rahane": 35,
  "Varun Chakravarthy": 28,
  "Angkrish Raghuvanshi": 22,
  "Rovman Powell": 12,
  "Manish Pandey": 4,
  "Rinku Singh": 4
};
...
discoveredTeams.forEach(team => {
  ...
  for (let r = 2; r < rows.length; r++) {
    ...
    for (const [key, val] of Object.entries(match51Points)) {
...
// Log players that were in Match 51 but not found in any team
...
for (const [name, pts] of Object.entries(match51Points)) {
