...
const screenshotPlayers = [
  "Mitchell Starc", "Lungi Ngidi", "Axar Patel", "Abishek Porel", "KL Rahul", 
  "Madhav Tiwari", "Ashutosh Sharma", "David Miller", "Sahil Parakh", 
  "Tristan Stubbs", "Tripurana Vijay", "Mukesh Kumar",
  "Riyan Parag", "Dhruv Jurel", "Vaibhav Sooryavanshi", "Jofra Archer", 
  "Dasun Shanaka", "Brijesh Sharma", "Yashasvi Jaiswal", "Yash Raj Punja", 
  "Ravi Singh", "Donovan Ferreira", "Shubham Dubey", "Adam Milne"
];
...
console.log("MATCHING RESULTS FOR MATCH 62:");
