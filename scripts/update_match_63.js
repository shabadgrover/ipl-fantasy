...
const match63 = matches.find(m => m.id === 63);
if (match63 && match63.isCompleted) {
  console.log("⚠️ Match 63 is already marked as completed in matches.js. Exiting to prevent duplicate updates.");
  process.exit(0);
}
...
discoveredTeams.forEach(team => {
    ...
    for (let r = 2; r < rows.length; r++) {
        ...
        for (const [key, val] of Object.entries(match63Points)) {
