...
const match66 = matches.find(m => m.id === 66);
if (match66 && match66.isCompleted) {
  console.log("⚠️ Match 66 is already marked as completed in matches.js. Exiting to prevent duplicate updates.");
  process.exit(0);
}
...
const ignoredPlayers = [
  ...
  "Kartik Sharma",
  "Gurjapneet Singh",
  "Uvil Patel", // include both spellings if needed
  "Urvil Patel",
  "Arshad Khan",
  "Nishant Sindhu"
];
...
discoveredTeams.forEach(team => {
    ...
    for (let r = 2; r < rows.length; r++) {
        ...
        for (const [key, val] of Object.entries(match66Points)) {
