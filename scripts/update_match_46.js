...
const match46Points = {
  ...
  "Marco Jansen": 90,
  "Arshdeep Singh": 89,
  "Vijaykumar Vyshak": 87,
  "Shreyas Iyer": 41,
  "Xavier Bartlett": 36,
  "Prabhsimran Singh": 27,
  "Cooper Connolly": 18,
  "Priyansh Arya": 6,
  "Yuzvendra Chahal": 4,
  "Nehal Wadhera": 2
...
discoveredTeams.forEach(team => {
  ...
  for (let r = 2; r < rows.length; r++) {
    ...
    const matchPoints = match46Points[cleanName] || 0;
