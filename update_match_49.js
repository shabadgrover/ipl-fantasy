...
const match49Points = {
  // SRH
  "Heinrich Klaasen": 121,
  "Nitish Kumar Reddy": 117,
  "Ishan Kishan": 113,
  "Pat Cummins": 100,
  "Abhishek Sharma": 91,
  "Travis Head": 84,
...
discoveredTeams.forEach(team => {
  ...
  for (let r = 2; r < rows.length; r++) {
    ...
    const matchPoints = match49Points[cleanName] || 0;
